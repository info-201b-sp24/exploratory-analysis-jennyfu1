...
Firstly, for hypertension. The majority of the research to far indicates that hypertension raises the chance of severe COVID-19, which is defined as 
mortality, admission to intensive care, or a clinically recognized severity or a combination of these. However, whether this predictive profile was independent 
...
over the world. Moreover, although the users in the dataset must admitted their information being used, we still need to keep every person's private information 
as secret.
...
because each location has its own management model or style. Changes in testing protocols, data collection methods, and reporting standards can lead to 
...
data lags and revisions can affect the accuracy and reliability of the data set, especially when analyzing trends over time.
...
diet provided to everyone are enough to help, and draw conclusions for future emergencies. They can learn about the different harms caused by different 
...
1,048,575 patients, but the dataset indicated that 4 or higher in the column of classification means that the patient is not a carrier of covid or that the 
...
there are 76727 patients who suffer from hypertension.  Furthermore, the dataset highlights that there are 29815 patients who are elderly, aged over 70 years. 
